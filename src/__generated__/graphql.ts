...
export type CountryQuizzesQuery = { __typename?: 'Query', quizList: Array<{ __typename?: 'QuizData', id: string, title: string, description: string, difficulty?: Difficulty | null, timeLimit?: number | null, image: string, tags?: Array<string> | null, createdAt: any, updatedAt: any, questions: Array<{ __typename?: 'QuestionData', question: string, type: string, options: Array<{ __typename?: 'OptionData', correct: boolean, text: string }> }>, creator: { __typename?: 'UserData', lastName?: string | null } }> };
